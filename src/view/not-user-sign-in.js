    ...
    <article class="info-redirect-home-page">
      ...
      <section>
        ...
        <div class="buttons-info">
          <a class="button-redirect-sign-in">Inicia sesión</a>
          <p>O</p>
          <a class="button-redirect-sign-up">Regístrate con una cuenta</a>
          <a id="button-redirect-home-page">Volver al Inicio</a>
        </div>
      </section>
    <article>
 `;
